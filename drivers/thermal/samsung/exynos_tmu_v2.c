	...
	if (!data->use_pi_thermal) {
		...
		for (i = 0; i < function->num_of_range; ++i) {
            ...
            if (function->range_list[i].max_frequency == 2600000 ||
				...
				function->range_list[i].max_frequency == 3000000) {  // Overclocked BIG core frequency
			...
			} else if (function->range_list[i].max_frequency == 2200000) {  // Overclocked LITTLE core frequency
				function->range_list[i].max_frequency = 2704000;
			}
